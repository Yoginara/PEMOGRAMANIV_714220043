...
class _MyInputFormState extends State<MyInputForm> {
  ...
  Map<String, dynamic>?
      editedData; // Variabel untuk menyimpan data yang sedang diedit
  ...
  void _addData() {
    ...
    setState(() {
      if (editedData != null) {
        ...
        editedData = null; // Kosongkan editedData setelah edit selesai
      } else {
  ...
  void _editData(Map<String, dynamic> data) {
    setState(() {
      ...
      editedData = data; // Simpan data yang akan diedit
    });
  }
        ...
        return AlertDialog(
          ...
          actions: [
            ...
            TextButton(
              onPressed: () {
                setState(() {
                  _myDataList.remove(data); // Menghapus data dari daftar
                });
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            Form(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 20),
                  ElevatedButton(
                    child: Text(editedData != null
                        ? "Update"
                        : "Submit"), // Mengubah teks tombol berdasarkan mode
                    onPressed: () {
            ...
            const SizedBox(height: 20),
            // Wrap ListView.builder with Expanded to make only it scrollable
            Expanded(
                  ...
                  return Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        IconButton(
                          onPressed: () {
                            _editData(data); // Memilih data untuk diedit
                          },
                        ...
                        IconButton(
                          onPressed: () {
                            _deleteData(
                                data); // Menampilkan dialog konfirmasi hapus
                          },
